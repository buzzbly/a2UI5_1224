CLASS zui1224_cl_pop_file_ul DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result)       TYPE REF TO zui1224_cl_pop_file_ul.
...
CLASS zui1224_cl_pop_file_ul IMPLEMENTATION.
  METHOD factory.
  ...
  METHOD zui1224_if_app~main.
    ...
    CASE client->get( )-event.
      ...
      WHEN `UPLOAD`.
        ...
        DATA(lv_data2) = zui1224_cl_util=>conv_decode_x_base64( lv_data ).
        ms_result-value = zui1224_cl_util=>conv_get_string_by_xstring( lv_data2 ).
