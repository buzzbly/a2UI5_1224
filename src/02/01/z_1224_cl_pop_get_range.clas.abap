CLASS z_1224_cl_pop_get_range DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result) TYPE REF TO z_1224_cl_pop_get_range.

    TYPES:
      BEGIN OF ty_s_result,
        t_range         TYPE z_1224_cl_util=>ty_t_range,
    ...
    DATA mt_mapping TYPE z_1224_if_types=>ty_t_name_value.
...
CLASS z_1224_cl_pop_get_range IMPLEMENTATION.
  METHOD factory.

    r_result = NEW #( ).

    z_1224_cl_util=>itab_corresponding( EXPORTING val = t_range
  ...
  METHOD z_1224_if_app~main.
    ...
    IF check_initialized = abap_false.
      ...
      mt_mapping = z_1224_cl_util=>filter_get_token_range_mapping( ).
      ...
      LOOP AT ms_result-t_range REFERENCE INTO DATA(lr_product).
        INSERT VALUE #( low    = lr_product->low
                        ...
                        key    = z_1224_cl_util=>uuid_get_c32( )
    ...
    CASE client->get( )-event.
      ...
      WHEN `POPUP_ADD`.
        INSERT VALUE #( key = z_1224_cl_util=>uuid_get_c32( ) ) INTO TABLE mt_filter.
