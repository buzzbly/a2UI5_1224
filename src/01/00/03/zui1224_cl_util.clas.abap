CLASS zui1224_cl_util DEFINITION
  PUBLIC
  INHERITING FROM zui1224_cl_abap_api
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS rtti_get_t_ddic_fixed_values
      ...
      RETURNING
        VALUE(result) TYPE zui1224_cl_abap_api=>ty_t_fix_val ##NEEDED.
...
CLASS zui1224_cl_util IMPLEMENTATION.
  ...
  METHOD filter_update_tokens.
    ...
    DATA(lt_range) = zui1224_cl_util=>filter_get_range_t_by_token_t( result[ name = name ]-t_token ).
  ...
  METHOD json_parse.
    TRY.
        ...
        zui1224_cl_ajson=>parse( val )->to_abap( EXPORTING iv_corresponding = abap_true
  ...
  METHOD json_stringify.
    TRY.
        ...
        DATA(li_ajson) = CAST zui1224_if_ajson( zui1224_cl_ajson=>create_empty( ) ).
