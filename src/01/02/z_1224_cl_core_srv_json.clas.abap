CLASS z_1224_cl_core_srv_json DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    METHODS request_json_to_abap
      IMPORTING
        val           TYPE string
      RETURNING
        VALUE(result) TYPE z_1224_if_core_types=>ty_s_request.

    METHODS response_abap_to_json
      IMPORTING
        val           TYPE z_1224_if_core_types=>ty_s_response
      RETURNING
    ...
    METHODS model_front_to_back
      IMPORTING
        view    TYPE string
        t_attri TYPE REF TO z_1224_if_core_types=>ty_t_attri
        model   TYPE REF TO z_1224_if_ajson.
...
CLASS z_1224_cl_core_srv_json IMPLEMENTATION.
  METHOD model_front_to_back.

    IF line_exists( t_attri->*[ view = view ] ).
      DATA(lv_view) = view.
    ELSE.
      lv_view = z_1224_if_client=>cs_view-main.
    ENDIF.

    LOOP AT t_attri->* REFERENCE INTO DATA(lr_attri)
         WHERE     bind_type = z_1224_if_core_types=>cs_bind_type-two_way
               AND view      = lv_view.
      TRY.
        ...
        CATCH cx_root INTO DATA(x).
          z_1224_cl_util=>x_raise( |JSON_PARSING_ERROR: { x->get_text( ) } | ).
      ENDTRY.
    ENDLOOP.
  ...
  METHOD model_back_to_front.
    TRY.
        ...
        DATA(ajson_result) = CAST z_1224_if_ajson( z_1224_cl_ajson=>create_empty( ) ).
        LOOP AT t_attri->* REFERENCE INTO DATA(lr_attri) WHERE bind_type <> ``.

          IF lr_attri->custom_mapper IS BOUND.
            DATA(ajson) = CAST z_1224_if_ajson( z_1224_cl_ajson=>create_empty(
                                                   ii_custom_mapping = lr_attri->custom_mapper ) ).
          ELSE.
            ajson = CAST z_1224_if_ajson( z_1224_cl_ajson=>create_empty(
                                             ii_custom_mapping = z_1224_cl_ajson_mapping=>create_upper_case( ) ) ).
          ENDIF.

          CASE lr_attri->bind_type.
            WHEN z_1224_if_core_types=>cs_bind_type-one_way
            OR z_1224_if_core_types=>cs_bind_type-two_way.
...
*              ASSERT sy-subrc = 0.
            ...
            WHEN z_1224_if_core_types=>cs_bind_type-one_time.
              ajson->set( iv_ignore_empty = abap_false
                          iv_path         = `/`
  ...
  METHOD request_json_to_abap.
    TRY.
        ...
        DATA(lo_ajson) = CAST z_1224_if_ajson( z_1224_cl_ajson=>parse( val ) ).

        DATA(lv_model_edit_name) = |/{ z_1224_if_core_types=>cs_ui5-two_way_model }|.

        result-o_model = z_1224_cl_ajson=>create_empty( ).
        ...
        TRY.
            ...
            result-s_control-app_start = z_1224_cl_util=>c_trim_upper( result-s_control-app_start ).
          CATCH cx_root.
        ENDTRY.
        ...
        result-s_control-app_start = z_1224_cl_util=>c_trim_upper(
                                         z_1224_cl_util=>url_param_get( val = `app_start`
  ...
  METHOD response_abap_to_json.
    TRY.
        ...
        ajson_result->set( iv_path = `/`
                           iv_val  = val-s_front ).
        ajson_result = ajson_result->filter( NEW z_1224_cl_core_srv_json( ) ).
  ...
  METHOD z_1224_if_ajson_filter~keep_node.
    ...
    CASE iv_visit.
      ...
      WHEN z_1224_if_ajson_filter=>visit_type-value.
      ...
      WHEN z_1224_if_ajson_filter=>visit_type-close.
